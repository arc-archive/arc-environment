 ...
 */
export declare function filterToEval(item: ARCVariable): boolean;
...
export declare class VariablesProcessor {
   ...
   */
  _processContextVariables(result: VariablesMap, variables: ARCVariable[], requireEvaluation?: ARCVariable[], runCount?: number): Promise<VariablesMap>;
